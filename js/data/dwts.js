...
window.DHD_CATEGORIES.push({
  ...
  items: [
    ...
    {slug:'val-chmerkovskiy', name:'Val Chmerkovskiy', alt:['Valentin Chmerkovskiy'], note:'Pros', tier:'mid', clue:'Maks’ brother. Two in a row.', wiki:'dancingwiththestars.fandom.com', page:'Valentin Chmerkovskiy'},
    ...
    {slug:'sasha-farber', name:'Sasha Farber', alt:[], note:'Pros', tier:'deep', clue:'Proposed on the show.', wiki:'dancingwiththestars.fandom.com'},
    {slug:'alan-bersten', name:'Alan Bersten', alt:[], note:'Pros', tier:'deep', clue:'Won with Hannah Brown.', wiki:'dancingwiththestars.fandom.com'},
    ...
    /* ── WINNERS ── */
    {slug:'kelly-monaco', name:'Kelly Monaco', alt:[], note:'Winners', tier:'deep', clue:'Won the very first season.', wiki:'en.wikipedia.org'},
    ...
    {slug:'rashad-jennings', name:'Rashad Jennings', alt:[], note:'Winners', tier:'deep', clue:'Giants running back.', wiki:'en.wikipedia.org'},
    ...
    {slug:'kaitlyn-bristowe', name:'Kaitlyn Bristowe', alt:[], note:'Winners', tier:'mid', clue:'The Bachelorette.', wiki:'en.wikipedia.org'},
    ...
    {slug:'joey-graziadei', name:'Joey Graziadei', alt:[], note:'Winners', tier:'mid', clue:'The Bachelor, then the mirrorball.', wiki:'dancingwiththestars.fandom.com'},
    ...
    {slug:'harry-jowsey', name:'Harry Jowsey', alt:[], note:'Contestants', tier:'deep', clue:'Too Hot to Handle.', wiki:'dancingwiththestars.fandom.com', page:'Harry Jowsey'},
    ...
    {slug:'barry-williams', name:'Barry Williams', alt:[], note:'Contestants', tier:'deep', clue:'Greg Brady.', wiki:'dancingwiththestars.fandom.com', page:'Barry Williams'},
