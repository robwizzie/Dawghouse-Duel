...
window.DHD_CATEGORIES.push({
  ...
  items: [
    ...
    {slug:'yogi-bear',       name:'Yogi Bear',       alt:[],                  note:'Yogi Bear',    tier:'mid',  clue:'Hat and collar, and smarter than the average one.', wiki:'hanna-barbera.fandom.com'},
    ...
    /* ── NICKELODEON ── */
    {slug:'spongebob',       name:'SpongeBob SquarePants',alt:['SpongeBob'],  note:'SpongeBob',    tier:'easy', clue:'Yellow, absorbent, works the fry cook station.',    wiki:'nickelodeon.fandom.com'},
    ...
    {slug:'jimmy-neutron',   name:'Jimmy Neutron',   alt:['Jimmy'],           note:'Jimmy Neutron',tier:'mid',  clue:'Enormous swirl of hair and a robot dog.',           wiki:'nickelodeon.fandom.com'},
    {slug:'danny-phantom',   name:'Danny Phantom',   alt:['Danny Fenton'],    note:'Danny Phantom',tier:'mid',  clue:'White hair, green eyes, half ghost.',               wiki:'nickelodeon.fandom.com'},
    ...
    {slug:'rocko',           name:'Rocko',           alt:[],                  note:"Rocko's Modern Life",tier:'deep',clue:'Australian wallaby in a blue shirt.',          wiki:'nickelodeon.fandom.com'},
    ...
    /* ── CARTOON NETWORK ── */
    {slug:'dexter',          name:'Dexter',          alt:[],                  note:"Dexter's Laboratory",tier:'mid',clue:'Orange hair, lab coat, purple gloves, secret lab.',wiki:'cartoonnetwork.fandom.com'},
    ...
    {slug:'johnny-bravo',    name:'Johnny Bravo',    alt:[],                  note:'Johnny Bravo', tier:'mid',  clue:'Blond pompadour, sunglasses, zero success.',        wiki:'cartoonnetwork.fandom.com'},
    {slug:'courage',         name:'Courage',         alt:['Courage the Cowardly Dog'],note:'Courage',tier:'mid', clue:'Pink dog, permanently terrified, in Nowhere.',      wiki:'cartoonnetwork.fandom.com'},
    ...
    {slug:'samurai-jack',    name:'Samurai Jack',    alt:['Jack'],            note:'Samurai Jack', tier:'mid',  clue:'White robe, topknot, thrown into the future.',      wiki:'cartoonnetwork.fandom.com'},
    ...
    {slug:'steven-universe', name:'Steven Universe', alt:['Steven'],          note:'Steven Universe',tier:'mid', clue:'Pink star on his shirt and a gem in his navel.',    wiki:'cartoonnetwork.fandom.com'},
    ...
    /* ── DISNEY TELEVISION ── */
    {slug:'kim-possible',    name:'Kim Possible',    alt:['Kim'],             note:'Kim Possible', tier:'mid',  clue:'Red hair, crop top, and a naked mole rat.',         wiki:'disney.fandom.com'},
    ...
    {slug:'darkwing-duck',   name:'Darkwing Duck',   alt:[],                  note:'Darkwing Duck',tier:'deep', clue:'Purple cape and mask. Let us get dangerous.',       wiki:'disney.fandom.com'},
